# Contributing to ausOpenData

Thank you for your interest in contributing to **ausOpenData**!

`ausOpenData` provides a lightweight R interface to the aus Open Data
